...
<div class="main">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-3">
                <img src="./Uploads/Picture/2017-08-11/598d8f4b969ac.jpg" width="60" height="60" />
            </div>
            <div class="col-xs-9">
                <?php echo ($user["username"]); ?><br/>
                南城都汇汇智园<br/>
                积分:<span class="text-danger">998</span>
            </div>
        </div>
        <div class="blank"></div>
        <div class="row text-center myLabel">
            <div class="col-xs-4 label-danger"><a href="#"><span class="iconfont">&#xe60b;</span>我的资料</a></div>
            <div class="col-xs-4 label-success"><a href="<?php echo U('My/repair');?>"><span class="iconfont">&#xe609;</span>我的报修</a></div>
