...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">姓名<span class="check-tips">（请填写报修人姓名）</span></label>
			<div class="controls">
		...
		<div class="form-item">
			<label class="item-label">电话<span class="check-tips">（请填写报修人电话）</span></label>
			<div class="controls">
		...
		<div class="form-item">
			<label class="item-label">地址<span class="check-tips">（请填写报修详细地址）</span></label>
			<div class="controls">
		...
		<div class="form-item">
			<label class="item-label">标题(简述报修问题)<span class="check-tips">（请填写简述报修问题）</span></label>
			<div class="controls">
		...
		<div class="form-item">
			<label class="item-label">内容<span class="check-tips">（请详细叙述报修内容）</span></label>
			<div class="controls">
				<textarea class="textarea input-large" name="intro" id="" cols="30" rows="6"><?php echo ((isset($info["intro"]) && ($info["intro"] !== ""))?($info["intro"]):''); ?></textarea>
			</div>
		</div>
    ...
    (function(){
        var ThinkPHP = window.Think = {
            "ROOT"   : "/wwwroot", //当前网站地址
            "APP"    : "/wwwroot/admin.php?s=", //当前项目地址
